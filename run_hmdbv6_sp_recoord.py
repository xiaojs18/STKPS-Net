...
from model_v6_sp_recoord import CNN_TRX
...
class Learner:
    ...
    def parse_command_line(self):
        ...
        parser.add_argument("--split", type=int, default=3, help="Dataset split.")################hmdb=3
        ...
        if args.dataset == "ssv2":
            ...
            args.traintestlist = os.path.join(args.scratch, "video_datasets_kinetics/splits")
    ...
    def train_task(self, task_dict):
        ...
        #target_total_logits=target_logits
        task_accuracy = self.accuracy_fn(target_total_logits, target_labels)
        task_loss_total=(task_loss+task_loss_global+task_loss_local)/3 
        #task_loss_total=task_loss
    ...
    def test(self, session):
        ...
        with torch.no_grad():
                ...
                for task_dict in self.video_loader:
                    ...
                    target_logits_global = model_dict['logits_global']######
                    target_logits_local = model_dict['logits_local']######
                    target_logits_total=(target_logits+target_logits_global+target_logits_local)/3###
