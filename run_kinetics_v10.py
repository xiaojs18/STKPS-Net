...
class Learner:
    ...
    def parse_command_line(self):
        ...
        parser.add_argument('--test_iters', nargs='+', type=int, help='iterations to test at. Default is for ssv2 otam split.', default=[30000])#############75000
